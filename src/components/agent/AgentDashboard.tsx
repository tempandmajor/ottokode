...
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from '../../../web-app/src/components/ui/card';
import { Badge } from '../../../web-app/src/components/ui/badge';
import { Button } from '../../../web-app/src/components/ui/button';
import { Tabs, TabsContent, TabsList, TabsTrigger } from '../../../web-app/src/components/ui/tabs';
import { Progress } from '../../../web-app/src/components/ui/progress';
import { Separator } from '../../../web-app/src/components/ui/separator';
...
import { MultiFilePreviewContainer } from '../composer/MultiFilePreviewContainer';
  ...
  return (
    <div className="space-y-6">
      ...
      <Tabs defaultValue="agents" className="space-y-4">
        ...
        <TabsContent value="multi-file" className="space-y-4">
          <div className="grid gap-4 md:grid-cols-2">
            <div>
              <Card>
                <CardHeader>
                  <CardTitle>Plan & Apply Changes</CardTitle>
                  <CardDescription>Create and review multi-file operations</CardDescription>
                </CardHeader>
                <CardContent>
                  <MultiFilePreviewContainer />
                </CardContent>
              </Card>
            </div>
            <div>
